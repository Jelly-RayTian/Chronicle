export const en = {
  ...
  folders: {
    ...
    contentIndexing: {
      enabled: 'Content indexing enabled',
      disabled: 'Content indexing disabled',
      enable: 'Enable content indexing',
      disable: 'Disable',
      reindex: 'Reindex now',
      edit: 'Edit',
      hide: 'Hide',
      ...
      disabledNote:
        'Enable to search inside .txt, .md, and supported source-code files for this folder.',
    },
    availability: {
      available: 'Available',
  ...
  search: {
    title: 'Search',
    description: 'Find files by filename or search inside locally indexed text contents.',
    formLabel: 'Search form',
    query: 'Search query',
    ...
    contentModeHint: 'Content search only covers folders with content indexing enabled.',
    results: '{{count}} results',
    resultsLabel: 'Search results',
    noMatchesTitle: 'No matches',
    noMatchesBody: 'Try a different keyword or switch search mode.',
    emptyTitle: 'Start typing to search',
    emptyBody: 'Filename search works everywhere; content search needs an enabled folder.',
  },
  settings: {
    title: 'Settings',
